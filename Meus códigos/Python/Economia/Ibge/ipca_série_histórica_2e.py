# -*- coding: utf-8 -*-
"""
Created on Tue Dec 22 13:54:56 2020
...
for VP in li_variação_peso:
    ...
    df_ncomercializáveis = dicionário1['C_NC_M'].loc[cond1,['dt',VP]]
    df_ncomercializáveis.rename(mapper={VP:'ncomercializáveis'},axis=1,inplace=True)
    #---------------------------------
    df_class1 = df_ipca.copy()
    df_class1 = df_class1.merge(df_comercializáveis,how='left',left_on='dt',right_on='dt')
    df_class1 = df_class1.merge(df_ncomercializáveis,how='left',left_on='dt',right_on='dt')
