class AlunosView {
  ...
  render(alunos) {
    ...
    alunos.forEach((aluno) => {
      ...
      let htmlMedias = `<td><a href="282edit.html?id=${aluno._id}">${aluno.nome}</a></td>`;
          ...
          htmlMedias += `<td>
            ${
              aluno.media[materia] !== undefined
                ? aluno.media[materia]
                : `<a href="282edit.html?id=${aluno._id}"> Incluir nota </a>`
            }
          </td>`;
        });
      } else {
        htmlMedias += `<td colspan="${this.materias.length}">
          <a href="282edit.html?id=${aluno._id}">Incluir notas</a>
        </td>`;
      }
