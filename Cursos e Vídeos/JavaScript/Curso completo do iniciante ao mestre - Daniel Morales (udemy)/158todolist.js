(function () {
  ...
  function Task(name, completed, createdAt, updatedAt) {
    ...
    //-- name é parâmetro obrigatório
    if (!name) {
      throw new Error('Task need a required parameter: name');
    }
    // this.name = name;
    //-- fazendo name virar privado; consequência: onde usava a propriedade name, agora vai ter que o usar o método getName
    let _name = name;
    ...
    // como não está utilizando a palavra this, pode usar a arrow function
    this.getName = () => _name;
  ...
  // Essa array deve chamar arrInstancesTasks //! destructuring
  ...
  function clickedUl(e) {
    ...
    const actions = {
      ...
      containerCancelButton: function () {
        ...
        currentLi.querySelector('.editInput').value = arrInstancesTasks[
          currentLiIndex
        ].getName();
      },
